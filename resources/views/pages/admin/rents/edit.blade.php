                ...
                <div class="mb-6">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-gray-900 dark:text-white" id="subTotal">Ks {{ number_format($rent->sub_total, 0) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900">
                    <div class="space-y-3 md:space-y-0 md:grid md:grid-cols-3 md:gap-4">
                        <div class="flex justify-between items-center md:block">
                            ...
                            <p class="text-lg font-semibold text-gray-800 dark:text-white" id="displaySubTotal">Ks {{ number_format($rent->sub_total, 0) }}</p>
                        </div>
                        <div class="flex justify-between items-center md:block">
                            <p class="text-sm text-gray-600 dark:text-gray-400 md:mb-1">Grand Total</p>
                            <p class="text-lg font-semibold text-green-600 dark:text-green-400" id="grandTotal">Ks {{ number_format($rent->total, 0) }}</p>
                        </div>
                        <div class="flex justify-between items-center md:block">
                            <p class="text-sm text-gray-600 dark:text-gray-400 md:mb-1">Due Amount</p>
                            <p class="text-lg font-semibold text-red-600 dark:text-red-400" id="dueAmount">Ks {{ number_format($rent->total_due, 0) }}</p>
                        </div>
                    </div>
