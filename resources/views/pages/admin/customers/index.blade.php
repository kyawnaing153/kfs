            ...
            <div class="flex flex-col gap-4 px-5 mb-4 sm:flex-row sm:items-center sm:px-6">
                ...
                <div class="ml-auto flex flex-col gap-2 w-full sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                    ...
                    <div class="w-full sm:w-64">
                        <form method="GET" action="{{ route('customers.index') }}" class="relative w-full">
                    ...
                    <div class="w-full flex flex-row gap-2 sm:w-auto">
                        <!-- Filter by Status -->
                        <form method="GET" action="{{ route('customers.index') }}" class="w-full sm:w-auto">
                        ...
                        @forelse ($customers as $customer)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full object-cover"
                                                src="{{ $customer->customerprofile() }}" alt="{{ $customer->name }}">
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500 dark:text-gray-400">
                                        @if ($customer->phone_number)
                                            <a href="tel:{{ $customer->phone_number }}" class="hover:underline">
                                ...
                                <td class="px-4 py-4 text-right">
                                    <div class="relative inline-block text-left" x-data="{ open{{ $customer->id }}: false }">
                                        <button type="button"
                                            @click="open{{ $customer->id }} = !open{{ $customer->id }}"
                                            @click.away="open{{ $customer->id }} = false"
                                            ...
                                            aria-haspopup="true" :aria-expanded="open{{ $customer->id }}">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="text-gray-500 dark:text-gray-400">
                                        ...
                                        <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No customers
                                            found</h3>
