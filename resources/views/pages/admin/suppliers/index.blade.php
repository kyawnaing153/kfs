            ...
            <div class="flex flex-col gap-4 px-5 mb-4 sm:flex-row sm:items-center sm:px-6">
                ...
                <div class="ml-auto flex flex-col gap-2 w-full sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                    ...
                    <div class="w-full sm:w-64">
                        <form method="GET" action="{{ route('suppliers.index') }}" class="relative w-full">
                        ...
                        @forelse ($suppliers as $supplier)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-500 dark:text-gray-400">
                                        @if ($supplier->phone_number)
                                            <a href="tel:{{ $supplier->phone_number }}" class="hover:underline">
                                ...
                                <td class="px-4 py-4 text-right">
                                    <div class="relative inline-block text-left" x-data="{ open{{ $supplier->id }}: false }">
                                        <button type="button"
                                            @click="open{{ $supplier->id }} = !open{{ $supplier->id }}"
                                            @click.away="open{{ $supplier->id }} = false"
                                            ...
                                            aria-haspopup="true" :aria-expanded="open{{ $supplier->id }}">
                                        ...
                                        <div x-show="open{{ $supplier->id }}"
                                            ...
                                            <div class="py-1" role="none">
                                                <!-- Toggle Status -->
                                                <form method="POST"
                                                    action="{{ route('suppliers.toggle-status', $supplier->id) }}"
                                                    class="inline">
                                                    @csrf
                                                    @method('POST')
                                                    <button type="submit"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="text-gray-500 dark:text-gray-400">
                                        ...
                                        <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No suppliers
                                            found</h3>
                ...
                <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div class="text-sm text-gray-700 dark:text-gray-400 mb-4 sm:mb-0">
                            Showing
                            <span class="font-medium">{{ $suppliers->firstItem() ?? 0 }}</span>
                            to
                            <span class="font-medium">{{ $suppliers->lastItem() ?? 0 }}</span>
                            of
